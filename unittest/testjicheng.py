...
class UntitledTestCase(unittest.TestCase):
    ...
    def test_catagory(self):
        ...
        b = driver.find_element_by_xpath(
            u"(.//*[normalize-space(text()) and normalize-space(.)='床垫'])[1]/following::img[1]")

        driver.execute_script("$(arguments[0]).click()", b)
        time.sleep(3)

        driver.find_element_by_xpath(
            u"(.//*[normalize-space(text()) and normalize-space(.)='地毯'])[1]/following::div[1]").click()
        time.sleep(3)
        driver.find_element_by_xpath(
            u"(.//*[normalize-space(text()) and normalize-space(.)='地毯'])[1]/following::a[1]").click()
